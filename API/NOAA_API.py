...
if __name__ == "__main__":
    ...
    example = NOAAData('cYihGLjDqcjmFxUhrhIfzIylZThVEQEb')
    weather_data = example.fetch_data(datasetid='GHCND', locationid='ZIP:28801', startdate='2010-05-01', enddate='2010-05-02', limit=1)
    print(weather_data)